...
from mjrl.algos.dapg_modified import DAPG
...
if job_data['algorithm'] != 'NPG':
    ...
    random.Random(job_data['seed']).shuffle(demo_paths)
    print("line 62-------details of data:", demo_paths[0]["actions"].shape, demo_paths[0]["observations"].shape, demo_paths[0]["rewards"].shape)
    ...
    if job_data['eval_rollouts'] >= 1:
        score = e.evaluate_policy(bc_agent.policy, num_episodes=job_data['eval_rollouts'], mean_action=True)
...
rl_agent = DAPG(e, bc_agent.policy, baseline, demo_paths,
